...
class q_ResNet1D_test9(nn.Module):
    """
    ResNet 1D
    ...
    def __init__(
        ...
        super(q_ResNet1D_test9, self).__init__()
        self.base_plane = 64
        ...
        self.input_block = nn.Sequential(
            ...
            nn.BatchNorm1d(self.base_plane), # 参数是前一层输出的维度。BatchNorm层输出的维度也是dim
